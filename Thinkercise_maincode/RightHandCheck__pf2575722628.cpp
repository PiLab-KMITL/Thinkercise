...
ARightHandCheck_C__pf2575722628::ARightHandCheck_C__pf2575722628(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ARightHandCheck_C__pf2575722628::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARightHandCheck_C__pf2575722628::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		...
		__Local__5 = FVector(0.300000, 0.300000, 0.300000);
	...
	auto& __Local__8 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__StaticMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__8 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ARightHandCheck_C__pf2575722628::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARightHandCheck_C__pf2575722628::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	bpv__StaticMesh__pf->SetCollisionProfileName(FName(TEXT("OverlapAllDynamic")));
	...
	(((FBoolProperty*)__Local__9)->SetPropertyValue_InContainer((bpv__StaticMesh__pf), true, 0));
	bpv__HitScore__pf = 0;
	bpv__CountScore__pf = 0;
	bpv__RStartCheck__pf = 0;
	bpv__CaloriesScore__pf = 0.000000f;
	bpv__ComboCount__pf = 0;
	...
	{
		__Local__12 = (AActor::StaticClass())->FindPropertyByName(FName(TEXT("bCanBeDamaged")));
		check(__Local__12);
		__Local__13 = __Local__12;
	}
	(((FBoolProperty*)__Local__12)->SetPropertyValue_InContainer((this), true, 0));
...
void ARightHandCheck_C__pf2575722628::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ARightHandCheck_C__pf2575722628::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ARightHandCheck_C__pf2575722628::bpf__ExecuteUbergraph_RightHandCheck__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ARightHandCheck_C__pf2575722628::bpf__ExecuteUbergraph_RightHandCheck__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ARightHandCheck_C__pf2575722628::bpf__Drop__pf()
{
	bpf__ExecuteUbergraph_RightHandCheck__pf_0(4);
}
void ARightHandCheck_C__pf2575722628::bpf__Pickup__pf(USceneComponent* bpp__AttachTo__pf)
{
	b0l__K2Node_Event_AttachTo__pf = bpp__AttachTo__pf;
	bpf__ExecuteUbergraph_RightHandCheck__pf_1(1);
}
void ARightHandCheck_C__pf2575722628::bpf__R_CountScore__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__CountScore__pf, 100);
	bpv__CountScore__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
}
void ARightHandCheck_C__pf2575722628::bpf__R_HitScore__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__HitScore__pf, 1);
	bpv__HitScore__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
}
void ARightHandCheck_C__pf2575722628::bpf__R_StartCheck__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__RStartCheck__pf, 1);
	bpv__RStartCheck__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
}
void ARightHandCheck_C__pf2575722628::bpf__R_CaloriesScore__pf()
{
	float bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf{};
	bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpv__CaloriesScore__pf, 0.200000);
	bpv__CaloriesScore__pf = bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf;
}
void ARightHandCheck_C__pf2575722628::bpf__R_ComboScore__pf()
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__ComboCount__pf, 1);
	bpv__ComboCount__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void ARightHandCheck_C__pf2575722628::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{2, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/StarterBundle/ModularSciFiMats/Materials/Decals/Words/MI_Cell.MI_Cell 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ARightHandCheck_C__pf2575722628::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{6, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.StaticMeshActor 
		...
		{9, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/Engine.PointerToUberGraphFrame 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ARightHandCheck_C__pf2575722628
{
	FRegisterHelper__ARightHandCheck_C__pf2575722628()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/HandCheck/RightHandCheck"), &ARightHandCheck_C__pf2575722628::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ARightHandCheck_C__pf2575722628 Instance;
};
FRegisterHelper__ARightHandCheck_C__pf2575722628 FRegisterHelper__ARightHandCheck_C__pf2575722628::Instance;
